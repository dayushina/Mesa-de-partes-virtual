                                ...
                                <div class="d-flex flex-column h-100">
                                    ...
                                    <div class="auth-content my-auto">
                                        <div class="text-center">
                                            ...
                                            <p class="text-muted mt-2">Inicia sesión para continuar en Mesa de Partes</p>
                                        </div>
                                            ...
                                            <div class="mb-3">
                                                <div class="d-flex align-items-start">
                                                    ...
                                                    <div class="flex-shrink-0">
                                                        <div class="">
                                                            <a href="auth-recoverpw-1.html" class="text-muted">¿Olvidó su contraseña?</a>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="mt-5 text-center">
                                            <p class="text-muted mb-0">¿No tienes una cuenta?<a href="auth-register-1.html" class="text-primary fw-semibold"> Regístrese ahora</a> </p>
                                        </div>
                                    </div>
...
"Me siento confiado Imponiendo el cambio sobre mí mismo. Es mucho más divertido progresar que mirar hacia atrás. Es por eso que I ultricies enim En Malesuada nibh diam on Tortor Neaded para lanzar bolas curvas."
                                                        </h4>
